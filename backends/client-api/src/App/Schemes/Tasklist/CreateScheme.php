...
class CreateScheme
{
    public static function Body()
    {
        return [
            ...
            "tasks" => Validator::create()->array(1)->str()->min(CODE_MIN_LEN)->max(CODE_MAX_LEN)->insertRegexRule(CODE_REGEX_ERROR, CODE_REGEX_RULE)->require(),
            "is_everyone" => Validator::create()->bool()->require(),
            "students" => Validator::create()->array(1)->str()->min(CODE_MIN_LEN)->max(CODE_MAX_LEN)->insertRegexRule(CODE_REGEX_ERROR, CODE_REGEX_RULE)->optional(),
            "deadline" => Validator::create()->datetime()->min(new DateTime())->require()
        ];
    }
